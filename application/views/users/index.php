        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Users Listing <a href="<?php echo base_url("users/add");?>" class="btn bg-indigo waves-effect right">Add New</a></h2>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url("users/edit/" . $value->sid)?>"><i class="material-icons">mode_edit</i></a>
                                            <a onclick="return confirm('Are you sure to perform this action?')" href="<?php echo base_url("users/delete/" . $value->sid)?>"><i class="material-icons">delete</i></a>
                                        </td>
                                    </tr>
                                    <?php
                                    } } else {
